...
int codigoAplicacion= 12;
    ...
    public void llenadoDeTablas() {
        ...
        List<clsBancos> listaBancos = banco.getListadoBancos();
        String[] dato = new String[3];
        for (int i = 0; i < listaBancos.size(); i++) {
            dato[0] = listaBancos.get(i).getTipoPersona();
            dato[1] = listaBancos.get(i).getDescripcion();
            dato[2] = listaBancos.get(i).getEstatus();
            modelo.addRow(dato);
        }       
    }
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        ...
        clsBancos banco = new clsBancos();
        banco.setTipoPersona(txtbuscado.getText());
    ...
    private void btnRegistrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegistrarActionPerformed
        clsBancos banco = new clsBancos();
        banco.setTipoPersona(txtTipoPersona.getText());
        banco.setDescripcion(txtDescripcion.getText());
